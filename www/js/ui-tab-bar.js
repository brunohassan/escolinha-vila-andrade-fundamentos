...
tabBar.selectItemByPageId = function(pageId) {
    itemList = tabBar.itemList.filter(item => {
        return item.pageId == pageId
    })
    itemIndex = itemList[0].itemIndex
    console.log(itemIndex)
    tabBar.selectItem(tabBar.itemList[itemIndex])
}
